...
# stock-X.Y (a specific stock release), drynetN, alphanet or betanet (the
# rolling ecash-com/bitcoin branch builds), or all (every flavor in the CI
# matrix, continuing past failures); remaining args go to the test runner.
# 
