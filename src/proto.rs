        ...
        pub mod v1 {
            ...
            impl ConsensusHex {
                pub fn decode<Message, T>(
                    self,
                    field_name: &str,
                ) -> Result<T, super::super::super::Error>
                where
                    Message: prost::Name,
                    T: bitcoin::consensus::Decodable,
                {
                    let Self { hex } = self;
                    let hex = hex
                        .ok_or_else(|| super::super::super::Error::missing_field::<Self>("hex"))?;
                    bitcoin::consensus::encode::deserialize_hex(&hex).map_err(|_err| {
                        super::super::super::Error::invalid_field_value::<Message>(field_name, &hex)
                    })
                }
            ...
            impl TryFrom<get_coinbase_psbt_request::ProposeSidechain> for CoinbaseMessage {
                type Error = super::super::super::Error;
            ...
            impl From<get_coinbase_psbt_request::ack_bundles::RepeatPrevious> for M4AckBundles {
                fn from(
                    repeat_previous: get_coinbase_psbt_request::ack_bundles::RepeatPrevious,
                ) -> Self {
            ...
            impl From<get_coinbase_psbt_request::ack_bundles::LeadingBy50> for M4AckBundles {
                fn from(
                    leading_by_50: get_coinbase_psbt_request::ack_bundles::LeadingBy50,
                ) -> Self {
...
pub use cusf::crypto::v1 as crypto;
